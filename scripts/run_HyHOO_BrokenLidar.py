...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='output_brokenlidar.dat',
    ...
    total_budgets = [1281, 2909, 4933, 6660, 21067, 42171, 76371, 102447, 131052, 166263, 201000, 231644, 263047,
                     284805, 337879, 374736]  # s=5e^-2
    # total_budgets = [1000, 2500, 5000, 7500, 10000, 12500, 15000, 20000, 25000, 30000, 35000, 40000, 45000, 50000,
    #                  55000, 60000, 65000, 70000, 75000]  # s=1e^-2
    # total_budgets = [1000, 2500, 5000, 7500, 10000, 12500, 15000, 20000, 25000, 30000, 35000, 40000, 45000, 50000,
    #                  55000, 60000, 65000, 70000, 75000]  # s=1e^-3
    # total_budgets = [1200, 2112, 3159, 5952, 15903, 36356, 63758, 79977, 100356, 130964, 157806, 206901, 185847, 268052,
    #                  290683, 281427, 353912, 358233, 416002, 491546, 462096, 534930, 548980]  # s=5e^-5
