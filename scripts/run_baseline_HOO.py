...
if __name__ == '__main__':
    ...
    # total_budgets = [200000, 300000, 400000, 500000]
    total_budgets = [1000]
    # total_budgets = [2000, 5000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000]
    total_num_queries = []
    total_num_nodes = []
    ...
    for b in total_budgets:
        ...
        for _n in range(num_exp):
            ...
            random.seed(fixed_seed + _n + b_)
            np.random.seed(fixed_seed + _n + b_)
            ...
            for c in range(args.args[0]):
                ...
                if args.model == 'Synthetic_baseline':
                    ...
                    model = models.__dict__[args.model](category_index=c, nc=args.args[0], d=args.args[1])
                ...
                try:
                    ...
                    memory_usage, overall_best_cells, overall_best_points, depth, overall_best_mean_values, nq = \
                        hyhoover.estimate_max_probability(nimc, args.nHOOs, rho_max, sigma, budget_for_each_HOO,
