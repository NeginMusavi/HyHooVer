...
def estimate_max_probability(nimc, num_HOO, rho_max, sigma, budget, batch_size, rand_sampling, output, eval_mult=100, debug=False):
    mfobject = MFNiMC(nimc, batch_size, rand_sampling, eval_mult)
