...
def map_int_to_discrete_part_in_search_space(element, set):
    """Given a point in {0, 1, 2} of ({0, 1, 2}, [0,1]^d), returns the representation in the original space in discrete part."""
    return set[element]
